...
INPUT_CHUNK="$1"
S3_OUTPUT_PATH="$2"
# Default to 3 threads if the third argument is not provided or is empty
ZSTD_THREADS="${3:-3}"
# Default to compression level 15 if the fourth argument is not provided or is empty
ZSTD_LEVEL="${4:-15}"
